...
public class UMLClass {
	 ...
	 */
	public boolean addField(String name, String type, String className) {
	 ...
	 */
	public boolean addParameter(String methodName, String paramName, String paramType){
		for(Method method : methods){
			if(method.getName().equals(methodName)){
				return method.addParameter(paramName, paramType);
			}
		}
		return false;
	}
	 ...
	 */
	public boolean deletePar(String methodName, String parameterName){
		for(Method method : methods){
			if(method.getName().equals(methodName)){
 ...
 @Override
	public String toString() {
		return printFiled() + printMethods();
	}
}
