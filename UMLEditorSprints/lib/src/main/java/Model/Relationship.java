    ...
    public void changeRelType(int type) {
        ...
        switch (type) {
            case 1:
                ...
                this.relationType = 1; // Association
                break;
            case 2:
                // Assign the integer representing the relationship type
                this.relationType = 2; // Aggregation
                break;
            case 3:
                this.relationType = 3; // Composition
                break;
            case 4:
                this.relationType = 4; // Inheritance
                break;
            case 5:
                this.relationType = 5; // Realization
                break;
            default:
